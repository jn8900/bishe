...
<div id="apDiv6"><a href="../index.html">注销</div>
		...
		<div class="two">
		<ul>
				<li><a href="noticelist.jsp">查看所有留言</a></li>
				<li><a href="noticedelete.jsp">删除留言</a></li>
				
</ul></div>
		<div class="three">		
<!-- ImageReady Slices (regconfirm) -->
<table width="812" height="79">
			<jsp:useBean id="clothebean" scope="page" class="mydb.mydb"/>
			<form action="noticedelete1.jsp" method="post">
			<tr>
			<td colspan="4">
			<input type="text" name="NAME">
			<input type="submit" value="查找">*请输入姓名</td>
			</tr>
			</form>
			<tr>
			<td>主题&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;消息内容&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;姓名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期</td>
...
<%
	...
	ResultSet rs = clothebean.executeQuery(sql);
...
<%
	...
	String subject,memo,name,date;
 	//打开数据库
	sql="select * from message order by id desc";
 	rs = clothebean.executeQuery(sql);
 	...
 	while(k<pagesize && rs.next())
	{
		...
		date = rs.getString(5);
  		...
  		out.print("<table>"); 
  		out.print("<tr><td width='200' height='20'>"+subject+"</td><td width='220' height='20'>"+memo+"</td><td width='200'  height='20'>"+name+"</td><td width='300'  height='20'>"+date+"</td><td width='100' height='20'><a href=noticeSaveDelete.jsp?id="+id+">删除</a></td></tr>");
...
<form action=noticedelete.jsp method=post>
    <table border=0 width="100%">
        <tr>
           ...
           <td width="68"><font size="2">　</font><a href=noticedelete.jsp?pageno=<%=prep%>><font size="2" color="#000000">[上一页]</font></a></td>
           <td width="55"><a href=noticedelete.jsp?pageno=<%=nextp%>><font size="2" color="#000000">[下一页]</font></a></td>
           <td width="55"><a href=noticedelete.jsp?pageno=1><font size="2" color="#000000">[第一页]</font></a></td>
           <td width="68"><a href=noticedelete.jsp?pageno=<%=pagecount%>><font size="2" color="#000000">[最后一页]</font></a></td>
