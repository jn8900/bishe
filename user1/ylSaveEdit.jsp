...
//对修改信息进行各种验证
if (password==null  || question.equals("") || answer.equals("") || name.equals("")  )
{%>
...
//修改数据库    
{     
String sql="update user set name='"+name+"',sex='"+sex+"',birthday='"+birthday+"',password='"+password+"',tel='"+tel+"',address='"+address+"',qq='"+qq+"',question='"+question+"',answer='"+answer+"',u_name='"+u_name+"' where id ="+id;  //注意数值型赋值方法  

editbean.executeUpdate(sql);
%> 
<script language='javascript'>
    alert("你成功更改了这个管理员")
    location='yledit.jsp';
