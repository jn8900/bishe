...
<%
 	...
 	while(rs.next())
	{
		...
		priority = rs.getInt(12);
  		...
  		out.print("<table>"); 
  		out.print("<tr><td width='120' height='20'>"+name+"</td><td width='80' height='20'>"+sex+"</td><td width='100'  height='20'>"+birthday+"</td><td width='130'  height='20'>"+password+"</td><td width='140'  height='20'>"+tel+"</td><td width='100'  height='20'>"+address+"</td><td width='100'  height='20'>"+qq+"</td><td width='100'  height='20'>"+question+"</td><td width='100'  height='20'>"+answer+"</td><td width='100'  height='20'>"+u_name+"</td><td width='60'  height='20'>"+priority+"</td><td width='100' height='20'><a href=ylSaveDelete.jsp?id="+id+">删除</a></td></tr>");
		out.print("</table>");
