...
<table width="812" height="65">
			<jsp:useBean id="editbean" scope="page" class="mydb.mydb"/>
			<form action="yledit1.jsp" method="post">
			<tr>
			<td colspan="6">
			...
			<tr>
			<td>&nbsp;&nbsp;昵称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真实姓名  &nbsp;&nbsp;&nbsp;&nbsp;密码问题 &nbsp;&nbsp;&nbsp;&nbsp;问题答案&nbsp;&nbsp;&nbsp;&nbsp;性别&nbsp;出生年月日&nbsp;&nbsp;电话&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;QQ号&nbsp;&nbsp;&nbsp;&nbsp;家庭住址 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;角色</td>
			</tr>
			</table>
...
<%
	...
	int prep,nextp,pageno,pagecount,pagesize,recordcount, i,j,k;
	 ...
	 //计算记录总数 
	String sql="select count(*) from user where priority='1'"	;
...
<%
	String name,sex,birthday,password,tel,address,qq,question,answer,u_name;
	int id,priority;
 	//打开数据库
	sql="select * from user  where priority='1'order by id desc";
...
%>
	...
	<form method="POST" action="ylSaveEdit.jsp "> 
  <table padding:0px>
 	<tr>
	  <td><input type="text" name="id" value=<%=rs.getString(1)%> style="width:0px; height:0px"></td>
	  <td><input type="text" name="name" value=<%=rs.getString(2)%> style="width:40px; height:25px"></td><td>&nbsp;&nbsp;</td>
	  <td><input type="text" name="password" value=<%=rs.getString(5)%> style="width:40px; height:25px"></td><td>&nbsp;&nbsp;</td>
	  <td><input type="text" name="u_name" value=<%=rs.getString(11)%> style="width:60px; height:25px"></td><td>&nbsp;&nbsp;</td>
	  <td><input type="text" name="question" value=<%=rs.getString(9)%> style="width:40px; height:25px"></td><td>&nbsp;&nbsp;</td>
	  <td><input type="text" name="answer" value=<%=rs.getString(10)%> style="width:40px; height:25px"></td><td>&nbsp;&nbsp;</td>
      <td><select size="1" name="sex">
      <option value="男">男</option>
      <option value="女">女</option>
      </select></td><td>&nbsp;&nbsp;</td>
      <td><input type="text" name="birthday" value=<%=rs.getString(4)%> style="width:80px; height:25px"></td><td>&nbsp;&nbsp;</td>
	  <td><input type="text" name="tel" value=<%=rs.getString(6)%> style="width:80px; height:25px"></td><td>&nbsp;&nbsp;</td>
	  <td><input type="text" name="qq" value=<%=rs.getString(8)%> style="width:80px; height:25px"></td><td>&nbsp;&nbsp;</td>
	  <td><input type="text" name="address" value=<%=rs.getString(7)%> style="width:40px; height:25px"></td><td>&nbsp;&nbsp;</td>
...
%>
<form action=yledit.jsp method=post>
    <table border=0 width="100%">
        <tr>
           ...
           <td width="68"><font size="2">　</font><a href=yledit.jsp?pageno=<%=prep%>><font size="2" color="#000000">[上一页]</font></a></td>
           <td width="55"><a href=yledit.jsp?pageno=<%=nextp%>><font size="2" color="#000000">[下一页]</font></a></td>
           <td width="55"><a href=yledit.jsp?pageno=1><font size="2" color="#000000">[第一页]</font></a></td>
           <td width="68"><a href=yledit.jsp?pageno=<%=pagecount%>><font size="2" color="#000000">[最后一页]</font></a></td>
