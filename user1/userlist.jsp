...
<table width="812" height="107">
			...
			<tr>
			<td width="7%" height="49" align="center">昵称</td>
...
<%
 	...
 	while(k<pagesize && rs.next())
	{
		...
		u_name = rs.getString(11);
		priority = rs.getInt(12);
%>
		
<%
  		out.print("<table>"); 
  		out.print("<tr><td width='120' height='20'>"+name+"</td><td width='80' height='20'>"+sex+"</td><td width='100'  height='20'>"+birthday+"</td><td width='130'  height='20'>"+password+"</td><td width='140'  height='20'>"+tel+"</td><td width='100'  height='20'>"+address+"</td><td width='100'  height='20'>"+qq+"</td><td width='100'  height='20'>"+question+"</td><td width='100'  height='20'>"+answer+"</td><td width='100'  height='20'>"+u_name+"</td><td width='60'  height='20'>"+priority+"</td></tr>");
		out.print("</table>");
...
<form action=userlist.jsp method=post>
    <table border=0 width="100%">
        <tr>
           ...
           <td width="68"><font size="2">　</font><a href=userlist.jsp?pageno=<%=prep%>><font size="2" color="#000000">[上一页]</font></a></td>
           <td width="55"><a href=userlist.jsp?pageno=<%=nextp%>><font size="2" color="#000000">[下一页]</font></a></td>
           <td width="55"><a href=userlist.jsp?pageno=1><font size="2" color="#000000">[第一页]</font></a></td>
           <td width="68"><a href=userlist.jsp?pageno=<%=pagecount%>><font size="2" color="#000000">[最后一页]</font></a></td>
