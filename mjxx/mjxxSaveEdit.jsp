...
session.putValue("product_name",product_name);

//对修改信息进行各种验证
if (product_name.equals("") || product_bb.equals("") ||product_sn.equals("")|| product_price==0|| product_discount==0|| product_type.equals("") )
{%>
...
//修改数据库    
{     
String sql="update clothelist set product_name='"+product_name+"',product_bb='"+product_bb+"',product_sn='"+product_sn+"',product_price="+product_price+",product_discount="+product_discount+",product_type='"+product_type+"' where product_id ="+product_id;  //注意数值型赋值方法  

mjxxbean.executeUpdate(sql);
%> 
<script language='javascript'>
    alert("你成功更改了这个商品")
    location='mjxxedit.jsp';
</script>
<%}%>
		</td>	
	</tr>
