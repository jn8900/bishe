...
<div class="two">
		...
		<table width="796" height="73">
			<jsp:useBean id="mjxxbean" scope="page" class="mydb.mydb"/>
			<form action="mjxxchakan1.jsp" method="post">
			<tr>
			<td colspan="6">
			<input type="text" name="name">
			<input type="submit" value="查找">*请输入服装名</td>
			</tr>
			</form>
			<tr>
			<td>商品编号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;材质&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;品牌&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价格  &nbsp; &nbsp;&nbsp; &nbsp;优惠价&nbsp;&nbsp;&nbsp;&nbsp;类别</td>
			</tr>
<%
...
<%
  		out.print("<table>"); 
  		out.print("<tr><td width='200' height='20'>"+product_name+"</td><td width='400' height='20'>"+product_bb+"</td><td width='260' height='20'>"+product_sn+"</td><td width='100'  height='20'>"+product_price+"</td><td width='80'  height='20'>"+product_discount+"</td><td width='80'  height='20'>"+product_type+"</td></tr>");
		out.print("</table>");
...
%>
<form action=mjxxchakan.jsp method=post>
    <table border=0 width="100%">
        <tr>
           ...
           <td width="68"><font size="2">　</font><a href=mjxxchakan.jsp?pageno=<%=prep%>><font size="2" color="#000000">[上一页]</font></a></td>
           <td width="55"><a href=mjxxchakan.jsp?pageno=<%=nextp%>><font size="2" color="#000000">[下一页]</font></a></td>
           <td width="55"><a href=mjxxchakan.jsp?pageno=1><font size="2" color="#000000">[第一页]</font></a></td>
           <td width="68"><a href=mjxxchakan.jsp?pageno=<%=pagecount%>><font size="2" color="#000000">[最后一页]</font></a></td>
